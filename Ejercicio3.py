...
def ahorcado():
    ...
    print("La palabra está relacionada con programación.")
    
    # Revelar la primera letra automáticamente
    primera_letra = palabra_secreta[0]
    letras_adivinadas.append(primera_letra)
