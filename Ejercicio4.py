...
def laberinto():
    laberinto = {
        ...
        "pasillo": {"norte": "salida", "sur": "entrada", "este": "cuarto oscuro", "oeste": "biblioteca"},
        "cuarto oscuro": {"norte": None, "sur": None, "este": None, "oeste": "pasillo"},
        "salida": {"norte": None, "sur": "pasillo", "este": None, "oeste": "jardín"},
        "biblioteca": {"norte": None, "sur": None, "este": "pasillo", "oeste": None},
        "jardín": {"norte": None, "sur": None, "este": "salida", "oeste": None},
    }
